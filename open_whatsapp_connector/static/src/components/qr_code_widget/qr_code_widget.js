...
export class QrCodeWidget extends Component {
    ...
    setup() {
        ...
        // NB: the post-connect "Import WhatsApp Data" prompt is NOT handled here.
        // This widget UNMOUNTS the instant the account becomes connected (its
        // container is invisible unless session_state is qr_pending/connecting),
        // so a JS latch here can never reliably fire it. The always-mounted
        // wa_import_prompt widget, driven by the server flag
        // owa.account.import_prompt_pending, owns the prompt. (#import_prompt_flag)
