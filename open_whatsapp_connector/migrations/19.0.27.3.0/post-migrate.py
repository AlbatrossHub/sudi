"""post-migrate for open_whatsapp_connector 19.0.27.3.0.
...
def migrate(cr, version):
    ...
    try:
        ...
        _logger.info(
            "[owc 19.0.27.3.0] refreshed 'Send WhatsApp' server actions "
            "(purchase.order added + report_xmlid threaded)")
    except Exception:
        _logger.exception(
            "[owc 19.0.27.3.0] failed to refresh Send-WhatsApp server actions")
